...
| 项 | 本目录（旧稿） | 现行权威稿 |
|---|---|---|
| 稿件 | `Reference_Matching_Interaction_English_Draft_20260914.docx`、`Reference_Matching_Interaction_中文对照_20260914.docx`、`English_Manuscript_Source.md` | `docs/paper_complete_review_20260920/Reference_Matching_Complete_English_20260920.docx` |
...
| 正文源 | `scripts/manuscript_build_20260914/{manuscript.md,results.md,tables.json,figures.json,references.json}` | `scripts/paper_complete_review_20260920/` 同名 5 文件 |
| 构建脚本 | `scripts/manuscript_build_20260914/build.py`、`build_cn_docx.py` | `scripts/paper_complete_review_20260920/build.py` |
...
1. **不要再编辑本目录的任何稿件正文**；正文改动一律落到 `scripts/paper_complete_review_20260920/` 的 5 个源文件，然后重跑该目录的 `build.py`。
