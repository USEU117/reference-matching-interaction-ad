...
| [DYNAMIC_FUSION_NEXT_STEPS.md](DYNAMIC_FUSION_NEXT_STEPS.md)、[DYNAMIC_FUSION_DESIGN_REVIEW_AND_NEXT_PLAN.md](DYNAMIC_FUSION_DESIGN_REVIEW_AND_NEXT_PLAN.md)、`dynamic_fusion_*.md` | 2026-08 的动态路由/融合开发记录 |
