...
Manuscript: the current authoritative draft is [docs/paper_complete_review_20260920/Reference_Matching_Complete_English_20260923.docx](docs/paper_complete_review_20260920/), built by `scripts/paper_complete_review_20260920/build.py` from `{manuscript.md, results.md, tables.json, figures.json, references.json}`; as of 2026-09-23 it measures **55 pages / 23 tables / 8 main figures plus S1–S6 (27 embedded images) / 12 numbered equations / 34 references / 19,394 words**. The previous draft of the same chain (`…20260920.docx`, 47 pages / 20 tables / 22 embedded images / 142 math objects / 17,221 words) is kept on disk as the pre-expansion anchor. The older chain [docs/manuscript_reference_matching_20260914/](docs/manuscript_reference_matching_20260914/) (18 tables / 8 figures, `build_validation.json`) is **superseded** — see its `SUPERSEDED_20260921.md`. **Submission status: in preparation / under review — not published**; citation metadata will be added once the venue or preprint is fixed.
...
论文当前权威稿在 [docs/paper_complete_review_20260920/Reference_Matching_Complete_English_20260923.docx](docs/paper_complete_review_20260920/)，由 `scripts/paper_complete_review_20260920/build.py` 从 `{manuscript.md, results.md, tables.json, figures.json, references.json}` 构建；2026-09-23 实测 **55 页 / 23 表 / 8 主图 + S1–S6（27 内嵌图）/ 12 编号公式 / 34 文献 / 19,394 词**。同链上一版（`…20260920.docx`，47 页 / 20 表 / 22 内嵌图 / 142 数学对象 / 17,221 词）作为扩版前锚点保留在盘。旧链 [docs/manuscript_reference_matching_20260914/](docs/manuscript_reference_matching_20260914/)（18 表 / 8 图，见其 `build_validation.json`）已标 **superseded**，见同目录 `SUPERSEDED_20260921.md`。**投稿状态：准备投稿 / 审阅中，尚未发表**；正式引用信息待定稿后补充。
