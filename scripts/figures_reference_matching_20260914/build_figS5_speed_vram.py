...
TICK_LABEL = {
    ...
    "controlled_A1_L": "A1\nL",
    "anomalydino_canvas": "ADino",
    "anomalydino_canvas_rotation": "ADino\n-rot",
    "PatchCore_native_local128": "PC\n128",
    "PatchCore_native_official224": "PC\n224",
}
...
PROTOCOL_SHORT = [
    ("A1 J / A1 L", "B = DINOv2-B/14 @448, C = AnomalyCLIP ViT-L/14@336 @518"),
    ("", "canvas 448x448, no rotation, bank K; L differs from J only in the fusion order"),
    ("ADino", "DINOv2-S/14 @448, canvas 448x448, no rotation, bank K"),
    ("ADino-rot", "DINOv2-S/14 @448, canvas 448x448, 8 rotations per reference, bank Kx8"),
    ("PC-128", "WideResNet50-2 layer2+3, resize 144 / imagesize 128, coreset 10%"),
    ("PC-224", "WideResNet50-2 layer2+3, resize 256 / imagesize 224, coreset 10%"),
]
