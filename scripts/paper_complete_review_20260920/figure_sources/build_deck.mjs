...
const R=path.resolve(path.dirname(fileURLToPath(import.meta.url)),'../../..'),T=R+'/.tmp_revision_20260925',O=R+'/docs/paper_complete_review_20260920',F=O+'/figures';
