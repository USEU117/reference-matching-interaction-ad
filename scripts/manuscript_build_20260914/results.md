...
On BTAD all four variants were run, together with the same sweep over four regularizer values. No interval excludes zero for either contrast: the canvas rule gives +0.001 points [−0.302, +0.259] for $I_{TRI}$ and −0.080 [−0.317, +0.164] for $I_{BAL}$, Procrustes gives +0.001 [−0.302, +0.259] and −0.080 [−0.317, +0.164], the position permutation gives +0.234 [−0.187, +0.579] and +0.217 [−0.279, +0.639], and the soft mixing at the prescribed regularizer gives +0.115 [−0.221, +0.505] and +0.103 [−0.233, +0.630]. The regularizer sweep spans the same range: the exact assignment gives +0.220 [−0.172, +0.697] and +0.148 [−0.369, +0.689], the intermediate 0.05 value gives +0.162 [−0.158, +0.629] and +0.156 [−0.198, +0.768], and the widest mixing at 0.5 gives +0.061 [−0.241, +0.373] and +0.025 [−0.268, +0.340]. All fourteen intervals span zero, so on this dataset neither replacing the correspondence nor changing the amount of smoothing in the transport rule changes the judgement, which was already "no evidence of a direction".
